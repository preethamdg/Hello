...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', 'https://t.me/+FOxMauI5h880ODA1')) #Notification of those who verify will be sent to your channel. Enter the ID of the channel you want to send notification to here.
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '0')) # add premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002487309952') #Channel / Group Id for force sub ( make sure bot is admin )
